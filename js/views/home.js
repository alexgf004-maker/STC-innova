  ...
  container.innerHTML = `
    <div class="ds-view anim-up">
      ...
      <div class="ds-acts" style="grid-template-columns:repeat(2,1fr)">
        <div class="ds-act" onclick="window.__router.navigateTo('reclamos')" style="padding:20px 10px">
          <div><svg viewBox="0 0 24 24" fill="none" stroke="var(--rc-light)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div>
          <div class="ds-act-t" style="font-size:13px;margin-top:11px">Mis órdenes</div>
        </div>
        <div class="ds-act" onclick="window.__router.navigateTo('bodega')" style="padding:20px 10px">
          <div><svg viewBox="0 0 24 24" fill="none" stroke="var(--rc-light)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg></div>
          <div class="ds-act-t" style="font-size:13px;margin-top:11px">Bodega</div>
        </div>
      </div>
...
function renderHomeTecnico(container, session, area, destino) {
  ...
  container.innerHTML = `
    <style>
      /* Solo lo dinámico por área que no puede ser clase fija */
      .dtec-camp-${color}{color:${accentColor}}
      .dtec-crew-${color} .companero-chip.self{background:${accentGlass};color:${accentColor};font-weight:600}
      .dtec-act-ic-${color}{color:${accentColor}}
    </style>
    ...
    <div class="ds-view anim-up">
      ...
      <div class="ds-acts" style="margin:28px 0">
        <div class="ds-act" onclick="window.__router.navigateTo('${rutaOrdenes}')">
          <div class="dtec-act-ic-${color}"><svg viewBox="0 0 24 24" fill="none" stroke="${accentColor}" stroke-width="1.8" stroke-linecap="round" width="20" height="20"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg></div>
          <div class="ds-act-t">Órdenes</div>
        </div>
        <div class="ds-act" onclick="window.__router.navigateTo('${rutaMapa}')">
          <div class="dtec-act-ic-${color}"><svg viewBox="0 0 24 24" fill="none" stroke="${accentColor}" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/><line x1="8" y1="2" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="22"/></svg></div>
          <div class="ds-act-t">Mapa</div>
        </div>
        <div class="ds-act" onclick="window.__router.navigateTo('bodega')">
          <div class="dtec-act-ic-${color}"><svg viewBox="0 0 24 24" fill="none" stroke="${accentColor}" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg></div>
          <div class="ds-act-t">Bodega</div>
        </div>
        <div class="ds-act" onclick="window.__abrirDevolucion()">
          <div class="dtec-act-ic-${color}"><svg viewBox="0 0 24 24" fill="none" stroke="${accentColor}" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><polyline points="9 10 4 15 9 20"/><path d="M20 4v7a4 4 0 01-4 4H4"/></svg></div>
          <div class="ds-act-t">Devolver</div>
        </div>
      </div>
